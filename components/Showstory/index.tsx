    ...
    <div className="  min-w-[100%]   md:pt-2 bg-black bg-black/30 bg-[url('/team-bg.png')] bg-cover">
      ...
      <div className="grid justify-items-center px-12 py-24 ">
        <h1 className="font-[Rancho] font-bold text-xl text-gray-800">
          ...
          imagination. His skin was red as fire, and his eyes glowed with an
          eerie light. He had the ability to conjure flames at will, and he used
        ...
        <h1 className="font-[Rancho] font-bold text-xl text-gray-800">
          ...
          wrong. But whatever his origins, there was no denying that he was a
          danger to society.
        </h1>{" "}
        <br />
        <h1 className="font-[Rancho] font-bold text-xl text-gray-800">
          ...
          stop him. But then, something unexpected happened. In the midst of his
          rampage, Red Devil spotted a young girl, cowering in fear behind a
          burning car. She was just a child, innocent and helpless. For a
          moment, Red Devil hesitated. He had never felt sympathy for anyone
          before, but something about the girl touched him. He wondered what had
          brought her into this chaos, and what would become of her if he
        ...
        <h1 className="font-[Rancho] font-bold text-xl text-gray-800">
          ...
          breathed a collective sigh of relief. Red Devil had been defeated, and
          the threat he posed had been neutralized. But the young girl whom Red
          Devil had spared could not forget what she had seen. She had seen
          something in Red Devil's eyes that day, something that made her
          believe that there was more to him than just a mindless monster. She
          began to research his past, looking for any clues that could explain
          his behavior.
        </h1>
        <br />
        <h1 className="font-[Rancho] font-bold text-xl text-gray-800">
          ...
          monster he had become. The young girl began to wonder if there was a
          way to reach him, to bring him back to the side of good. It was a
          risky proposition, but the girl was determined. She approached the
          authorities and asked for permission to speak with Red Devil. At
          first, they refused, but she persisted, and eventually, they relented.
          The meeting between the girl and Red Devil was set up in a secure
          room, with guards watching from behind a two-way mirror. The girl was
          nervous, but determined. As Red Devil entered the room, she could feel
        ...
        <h1 className="font-[Rancho] font-bold text-xl text-gray-800">
          ...
          Something happened to you, something that turned you into the monster
          you are now. But I believe that there's still some humanity left in
          you. I want to help you find it." Red Devil looked at the girl,
