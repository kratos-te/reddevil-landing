        ...
        >
          <div className="flex flex-col md: pr-[8.75%]">
            ...
            <div className="text-[24px] pb-[7.1%] text-white font-black ">
              There’s no denying it: NFTs are fundamentally reshaping the
              digital economy, taking blockchain to unpreedented prominence in a
              new era of web3. It all started with the first NFT ever created
              called, QUANTUM, which was minted by Kelvin McCoy on Namecoin in
              2014. But several ther NFTs were launched on pre-Ethereum
              blockchains over the following years-for example, spells of
              Genesis launched 2015, stands as the first-ever blockchain based
              game. Rare pepes came out in 2016 and gelped kick off the first
              crypto art market.
            </div>
            <Link
              href="/"
